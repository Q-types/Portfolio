"""KSP Packaging Estimator - Core Functions Module

This module provides the core functionality for the KSP & Buckingham Screen Print
...
def load_data():
    ...
    df = pd.read_csv('/Users/q/PythonScript/Python/DataAnalysis/KSP/Variables_EQ_GPT.csv')
...
def create_invoice(company_name, job_description, final_estimate, estimate_number):
    ...
    import os
    from datetime import datetime
    # KSP company details for invoice header
    ksp_name = "KSP & Buckingham Screen Print"
    ksp_address = """
    3 Riverside
